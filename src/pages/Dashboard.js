...
const Dashboard = () => {
  ...
  const fetchArticles = useCallback(async () => {
    try {
      ...
      // Filter articles based on user preferences and not blocked/deleted
    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          {user.preferences && user.preferences.map((category) => (
            <button
              key={category}
            ...
            >
              <Link to={`/articles/${article._id}`} className="flex flex-col md:flex-row">
                ...
                <div className="p-6 md:w-2/3 lg:w-3/4">
                  ...
                  <h2 className="text-2xl font-bold mb-3 card-title hover:text-primary-600 
